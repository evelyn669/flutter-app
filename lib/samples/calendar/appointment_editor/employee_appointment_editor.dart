...
class EmployeeAppointmentEditor extends SampleView {
  /// creates the appointment editor
  const EmployeeAppointmentEditor(Key key) : super(key: key);

  @override
  _EmployeeAppointmentEditorState createState() =>
      _EmployeeAppointmentEditorState();
}

class _EmployeeAppointmentEditorState extends SampleViewState {
  _EmployeeAppointmentEditorState();
