...
class ManagerAppointmentEditor extends SampleView {
  /// creates the appointment editor
  const ManagerAppointmentEditor(Key key) : super(key: key);

  @override
  _ManagerAppointmentEditorState createState() =>
      _ManagerAppointmentEditorState();
}

class _ManagerAppointmentEditorState extends SampleViewState {
  _ManagerAppointmentEditorState();
...
//// the given width agenda view will render the web UI.
  ...
  Widget build([BuildContext context]) {
    final Widget _calendar = Theme(
        ...
        child: _getAppointmentEditorCalendar(calendarController, _events,
            _onCalendarTapped, _onViewChanged));
  ...
  List<Appointment> _getAppointmentDetails() {
    ...
    final Random random = Random();
      for (int day = 0; day <= 28+6-(today.weekday % 7); day++) {

          // first shift
          appointmentCollection.add(Appointment(
            startTime: today
                .add(Duration(days: day, hours: 10 - today.hour, minutes: 0 - today.minute)),
            endTime: today
                .add(Duration(days: day, hours: 10 - today.hour + 4, minutes: 0 - today.minute)),
          ...
          appointmentCollection.add(Appointment(
            startTime: today
                .add(Duration(days:  day, hours: 14 - today.hour, minutes: 0 - today.minute)),
            endTime: today
                .add(Duration(days: day, hours: 14 - today.hour + 4, minutes: 0 - today.minute)), 
            color: _colorCollection[2],
            startTimeZone: '',
            endTimeZone: '',
            notes: '',
	  ...
	  // third shift
          appointmentCollection.add(Appointment(
            startTime: today
                .add(Duration(days:  day, hours: 18 - today.hour, minutes: 0 - today.minute)),
            endTime: today
                .add(Duration(days: day, hours: 18 - today.hour + 4, minutes: 0 - today.minute)),
            color: _colorCollection[2],
            startTimeZone: '',
            endTimeZone: '',
            notes: '',
